...
if __name__ == "__main__":
    with st.sidebar:
        ...
        st.write('**1)** Select the roll you want and enter your content for that roll')
        st.write("**2)** When you are done, click 'append line to messages'")
        st.write('**3)** repeat steps 1 and 2 as many times as necessary')
        st.write("**4)** finally, click 'append messages to JSON file' and repeate all steps until your file is complete")
        st.write()
