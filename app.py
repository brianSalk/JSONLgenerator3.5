...
if __name__ == "__main__":
    ...
    if st.button('Append Messages to JSONL file', disabled=not st.session_state['next_message']):
        st.session_state['messages'].append(st.session_state['next_message'])
        st.session_state['next_message'] = []

    st.subheader(':point_down: :point_down: Your JSONL file is here :point_down: :point_down: ')
